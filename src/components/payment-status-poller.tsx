      ...
      <div className="rounded-2xl border border-emerald-300/35 bg-emerald-400/15 p-4 text-emerald-50">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-emerald-50/85">Seu plano foi liberado. O anúncio já pode aparecer como ativo.</p>
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              <Link href="/dashboard?meus=ACTIVE#meus-anuncios" className="inline-flex h-10 items-center justify-center rounded-full border border-white/10 px-4 text-sm font-black text-white">
                Minha Conta
              </Link>
            </div>
          </div>
